About orange3-bioinformatics-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/orange3-bioinformatics-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/orange3-bioinformatics-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add orange3-bioinformatics
# for installing globally
pixi global install orange3-bioinformatics
```
...
It is possible to list all of the versions of `orange3-bioinformatics` available on your platform:
...
```
pixi search orange3-bioinformatics --channel conda-forge
```
